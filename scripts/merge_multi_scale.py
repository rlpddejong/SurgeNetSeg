...
from cutie.utils import palette

from cutie.utils.palette import custom_palette, youtube_palette
import shutil
...
if __name__ == '__main__':
    ...
    if 'D' in args.dataset:
        palette = ImagePalette.ImagePalette(mode='P', palette=custom_palette)
