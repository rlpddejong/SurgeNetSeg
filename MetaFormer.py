...
def caformer_s18(num_classes=0, pretrained='SurgNet', weights=None, **kwargs):
...
def rename_statedict_dino(weights):
    """
    Rename the keys of the state dict of a DINO model to be compatible with timm.
    Parameters
    ----------
    weights: dict
        State dict of a DINO model.
    Returns
    -------
    new_weights: dict
        State dict with keys renamed to be compatible with timm.
    """

    state_dict_teacher = {}
    teacher_weights = weights['teacher']
...
if __name__ == "__main__":
    weights = r"C:\Users\20182054\Documents\intrasurge\SurgNet2M_models\weights\SurgNet2M\caformer0100.pth"
